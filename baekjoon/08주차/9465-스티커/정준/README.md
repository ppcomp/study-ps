...
DP를 이용한 전형적인 문제, 점화식을 찾는 것이 중요하다.
...
초록색 부분을 떄면 빨간색 부분을 못쓰고 그다음으로 떌 수 있는 가장 근접부분은 주황색 부분이다.

하지만 주황색 100부분은 주황색 50부분을 떄도 땔 수 있는 부분이기 때문에

때어낸 스티커의 대각선 부분이 다음으로 땔만한 스티커라고 할 수 있다.
