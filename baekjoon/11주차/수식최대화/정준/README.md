...
입력받은 수식을 세개의 연산자 우선순위 경우의 수를 모두 계산함

계산법

1. 주어진 수식을 후위표기법으로 변경
2. 후위표기된 수식을 계산
3. 절대값이 최대값인지 확인하고 최대값을 갱신

## 결과

---
![image](https://user-images.githubusercontent.com/47655983/103508890-37f05600-4ea5-11eb-9e35-0e036b17e5b2.png)